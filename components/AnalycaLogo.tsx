...
export default function AnalycaLogo({ size = 'md', showText = false, subtitle }: AnalycaLogoProps) {
  ...
  return (
    <div className="flex items-center gap-3">
      <div className={`${sizeClasses[size]} ${borderRadius[size]} bg-gradient-to-br from-purple-500 via-purple-600 to-emerald-400 flex items-center justify-center shadow-sm`}>
